# Groovy Foxbot
Show a list of groovy shoes and festival locations
...
- Setup LUIS
    ...
    msbot clone services --name "Groovy Foxbot" --luisAuthoringKey <LUIS-authoring-key> --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
    ```
- Start the bot
    ```bash
    npm start
...
- Navigate to `Groovy Foxbot` folder
- Select `Groovy Foxbot.bot` file
